                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        <div className="bg-surface/50 rounded-xl overflow-hidden border border-white/10 shadow-lg">
                                            <VideoPlayer src="https://pub-c9add4fb2a554c62867fd1ad02e30165.r2.dev/formation-control-media/4Agents.mp4#t=0.1" />
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="bg-surface/50 rounded-xl overflow-hidden border border-white/10 shadow-lg">
                                            <VideoPlayer src="https://pub-c9add4fb2a554c62867fd1ad02e30165.r2.dev/formation-control-media/5Agents.mp4#t=0.1" />
                                        </div>
                                    ...
                                    <div className="space-y-3 md:col-span-2 md:w-2/3 md:mx-auto">
                                        <div className="bg-surface/50 rounded-xl overflow-hidden border border-white/10 shadow-lg">
                                            <VideoPlayer src="https://pub-c9add4fb2a554c62867fd1ad02e30165.r2.dev/formation-control-media/5AgentsSNN.mp4#t=0.1" />
                                        </div>
